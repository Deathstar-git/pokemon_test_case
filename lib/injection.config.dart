...
import 'package:pokemon_test_case/bloc/pokemon_bloc/pokemon_bloc.dart' as _i9;
...
import 'package:pokemon_test_case/infrascructure/features/services/pokemon_api.dart'
    as _i5;
import 'package:pokemon_test_case/infrascructure/features/services/pokemon_randomizer.dart'
    as _i6;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.PokemonRandomizer>(
        () => _i6.PokemonRandomizer(gh<_i5.PokemonApi>()));
    gh.factory<_i7.IPokemonRepository>(
        () => _i8.PokemonRepository(gh<_i5.PokemonApi>()));
    gh.factory<_i9.PokemonBloc>(() => _i9.PokemonBloc(
          gh<_i7.IPokemonRepository>(),
          gh<_i6.PokemonRandomizer>(),
        ));
    return this;
  }
}
